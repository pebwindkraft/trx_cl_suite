...
chksum_ref="8fd90cb9734489353e52160f0d691d2ea720e5dbde646cf6b0b934ca8734583d"
cp tcls_tx2txt.sh tmpfile
chksum_prep
 
echo "=== TESTCASE 1b: $chksum_cmd tcls_in_sig_script.sh" | tee -a $logfile
chksum_ref="430b14fb802928597e0d27e9ab9a536838fa98908ce4da88691bef112d41a7ae" 
cp tcls_in_sig_script.sh tmpfile
chksum_prep

echo "=== TESTCASE 1c: $chksum_cmd tcls_out_pk_script.sh" | tee -a $logfile
chksum_ref="64e776d106f5a17258650fb2f2f7ea94a0ab7d9f73ce0957ce8c071cdf5f0f58" 
...
echo "=============================================================" | tee -a $logfile
echo "=== TESTCASE 11a: unsigned tx, cold storage prep" | tee -a $logfile
...
echo "=== TESTCASE 11b: verbose unsigned tx, cold storage prep" | tee -a $logfile
...
echo "=== TESTCASE 11c: very verbose unsigned tx, cold storage prep" | tee -a $logfile
...
chksum_ref="a75307c10f5cce296920b1476a6408fd7ea2fcff3b7a1784478ca8e7fdc00aeb"
chksum_prep

echo "=== TESTCASE 11d: final tx, signed" | tee -a $logfile
./tcls_tx2txt.sh -vv -r  > tmpfile
chksum_ref="45f2280f1ac10c565c0c1636fbe2b87fbf76789dcc8d89efefc2d6f7c570eeb0"
chksum_prep
echo " " | tee -a $logfile
...
chksum_ref="4e26273fffd893023485b8d4d7aa42474680764adc8db958432ead3af59318d1"
chksum_prep

echo "=== TESTCASE 12d: a 1-of-4 Multisig: " | tee -a $logfile
...
echo "=============================================================" | tee -a $logfile
echo "=== TESTCASE 14: SegWit tx                                ===" | tee -a $logfile
echo "=============================================================" | tee -a $logfile
...
echo "=== TESTCASE 14q: SEGWIT tx with 10 inputs and 11 outputs" | tee -a $logfile
echo "https://blockchain.info/rawtx/497e90946be5ac4076497476c221d5165549e45040700d06f0b10091e2f144d5" >> $logfile
./tcls_tx2txt.sh -vv -t 497e90946be5ac4076497476c221d5165549e45040700d06f0b10091e2f144d5 > tmpfile
chksum_ref="6501b68b2dedbe45cd2d6d161265d68797f99855ca2c64ce8096aa8907072094"
chksum_prep
...
echo "=============================================================" >> $logfile
echo "=== TESTCASE 15a: TESTNET, simple tx" | tee -a $logfile
./tcls_tx2txt.sh -T -vv -r  > tmpfile
chksum_ref="4ef0bc26c335a46e933455aa1887d7d93eb90722e5bf184837f79dbf58bd1ac7"
chksum_prep

echo "=== TESTCASE 15b: TESTNET multisig addresses" | tee -a $logfile
...
chksum_ref="1a84158c6b24a773f8878353dedbf6fb1084e3d800dc4cbcaae5343a8343b450"
chksum_prep
...
chksum_ref="34871c757eea3366fbd97cba4d67ca050b5ec5752a5df1be010363b42c761052"
chksum_prep
...
chksum_ref="397e20e0f17aa74f8373f2445d98663734a7ab48bc136fe967e678cbedc5237a"
chksum_prep
...
chksum_ref="419191c4ffafbe7606836122ebc825bda64b7543547bd1b9a765b66331501882"
chksum_prep
...
chksum_ref="ce0f3899cf78b202e13be6f97d623a4e2e4d37238e820f95126c62b44300f007"
chksum_prep
...
testcase18() {
echo "=============================================================" | tee -a $logfile
echo "=== TESTCASE 18: Bogus transactions ...                   ===" | tee -a $logfile
echo "=============================================================" | tee -a $logfile
echo "=== TESTCASE 18a: XCP Proof-of-Burn" | tee -a $logfile
./tcls_tx2txt.sh -vv -t 44a8cbbc943f5ef772800f3483e78966d84c15ace6d1dec1de212127c3028531 > tmpfile
chksum_ref="dbb9e6ababc7304576b463c139c80634b50753fbbeb7f2312812a79b178f08e5"
chksum_prep

echo "=== TESTCASE 18b: XCP Proof-of-Burn" | tee -a $logfile
./tcls_tx2txt.sh -vv -t d54a3728580eb61a562540b8947a57ee162d4a33f89dac70f8dc22eba008cced > tmpfile
chksum_ref="b0a793d31211a8138a84e2f809ff27803993312281a31e7348ae49c3c277b812"
chksum_prep

# echo "=== TESTCASE 18c: XCP Proof-of-Burn" | tee -a $logfile
# ./tcls_tx2txt.sh -vv -t  > tmpfile
# chksum_ref="15c2738f7f9bb9db7621ec99c52709017797f07ad3dd2840b0c371ea7a60e345"
# chksum_prep
# 
# echo "=== TESTCASE 18d: XCP Proof-of-Burn" | tee -a $logfile
# ./tcls_tx2txt.sh -vv -t  > tmpfile
# chksum_ref="15c2738f7f9bb9db7621ec99c52709017797f07ad3dd2840b0c371ea7a60e345"
# chksum_prep
# 
# echo "=== TESTCASE 18e: XCP Proof-of-Burn" | tee -a $logfile
# ./tcls_tx2txt.sh -vv -t  > tmpfile
# chksum_ref="15c2738f7f9bb9db7621ec99c52709017797f07ad3dd2840b0c371ea7a60e345"
# chksum_prep
...
testcase19() {
echo "=============================================================" | tee -a $logfile
echo "=== TESTCASE 19: OP_Return transactions ...               ===" | tee -a $logfile
echo "=============================================================" | tee -a $logfile
echo "=== TESTCASE 19a: OP_Return" | tee -a $logfile
echo "https://blockchain.info/tx/52dd20f60d6e14e5a783e7668cf410efdea40cd9a92479b0f2423d0bc63575fa?format=hex" >> $logfile
./tcls_tx2txt.sh -vv -r  > tmpfile
chksum_ref="614aece511fdea534ec6fa865d46121628272f6dc78e16d064cc910a22d17a29"
chksum_prep

echo "=== TESTCASE 19b: OP_Return" | tee -a $logfile
echo "https://blockchain.info/tx/728e24b2e7dd137e574c433a8db08ac2aa0bf0588ad7716e4c5a7da45dbb5933?format=hex" >> $logfile
./tcls_tx2txt.sh -vv -r  > tmpfile
chksum_ref="77d5a1b32779b58259d416ae57c35be70a46ea43b8305f0d0b3ff60f14129401"
chksum_prep

echo "=== TESTCASE 19c: OP_Return" | tee -a $logfile
echo "https://blockchain.info/tx/d276abe15791941649c3ca8425d79167cc1cf801f83aa99753fe7f42740c0f23?format=hex" >> $logfile
./tcls_tx2txt.sh -vv -r  > tmpfile
chksum_ref="22aafc3e7af5b2ceb964afe79b2264e8cc5023ba8003a1c5588fea5f74178eb0"
chksum_prep

echo "=== TESTCASE 19d: OP_RETURN" | tee -a $logfile
...
chksum_ref="be04ab4aa1fa259f1075e42d657cfcb4216d6355b99caf2720e638ed830c77bc"
chksum_prep
