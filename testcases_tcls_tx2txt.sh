...
chksum_ref="626db275d2e9363886bf27fe8f5722b1019cd948a30adc9ca9a7bc2a79b0c1b6"
...
echo "=== TESTCASE 2h: wrong params, -r and -t together: ./tcls_tx2txt.sh -r 01000000013153f60f294bc14d0481138c1c9627ff71a580b596987a82e9eebf2ae3de232202000000fc00 -t def" | tee -a $logfile
./tcls_tx2txt.sh -r 01000000013153f60f294bc14d0481138c1c9627ff71a580b596987a82e9eebf2ae3de232202000000fc00 -t def > tmpfile
chksum_ref="7bec4d7ac4510c39e6845b18188f163718d279f69f832612a864dcfb167abc9c" 
chksum_prep

echo "=== TESTCASE 2i: wrong params, -r and -u together: ./tcls_tx2txt.sh -r 01000000013153f60f294bc14d0481138c1c9627ff71a580b596987a82e9eebf2ae3de232202000000fc00 -u def" | tee -a $logfile
./tcls_tx2txt.sh -r 01000000013153f60f294bc14d0481138c1c9627ff71a580b596987a82e9eebf2ae3de232202000000fc00 -u def > tmpfile
chksum_ref="3cd1e95ea9a161ba8dee7fd957f6a283e1d95ad0f562ac8994d0bf0986219c3e" 
chksum_prep

echo "=== TESTCASE 2j: wrong params, -t and -u together: ./tcls_tx2txt.sh -t 7bec4d7ac4510c39e6845b18188f163718d279f69f832612a864dcfb167abc9c -u def" | tee -a $logfile
./tcls_tx2txt.sh -t 7bec4d7ac4510c39e6845b18188f163718d279f69f832612a864dcfb167abc9c -u def > tmpfile
chksum_ref="3cd1e95ea9a161ba8dee7fd957f6a283e1d95ad0f562ac8994d0bf0986219c3e" 
chksum_prep

echo "=== TESTCASE 2k: wrong params, -f without param: ./tcls_tx2txt.sh -f " | tee -a $logfile
./tcls_tx2txt.sh -f > tmpfile
chksum_ref="35aebd5aff6c4aa9cc5b1510db7d403df0c4221eb58509f9f3576ce0c7503e1a" 
chksum_prep
 
echo "=== TESTCASE 2l: wrong params, file abc unknown: ./tcls_tx2txt.sh -f abc" | tee -a $logfile
./tcls_tx2txt.sh -f abc > tmpfile
chksum_ref="0414167aa53d245a7f3f58c990b87c419df4745095c87d02c0515cfe5ee03718" 
chksum_prep
 
echo "=== TESTCASE 2m: show help: ./tcls_tx2txt.sh -h" | tee -a $logfile
./tcls_tx2txt.sh -h > tmpfile
chksum_ref="f53a7f9732f5f8e3ed7018931b4907749202979784d716b4719645ad017ef40b" 
chksum_prep

echo "=== TESTCASE 2n: show default: ./tcls_tx2txt.sh" | tee -a $logfile
./tcls_tx2txt.sh > tmpfile
chksum_ref="78241272d4657c65966eae49b8f245a20ba2a720ea5cf6c7238cda5b9067d7dd" 
chksum_prep

echo "=== TESTCASE 2o: show verbose default: ./tcls_tx2txt.sh -v" | tee -a $logfile
./tcls_tx2txt.sh -v > tmpfile
chksum_ref="7d03bb39c4fa8fae31b4a59ab77f40ce92214ac3e90012096d3c9854a4bceba4" 
chksum_prep

echo "=== TESTCASE 2p: show very verbose default: ./tcls_tx2txt.sh -vv" | tee -a $logfile
...
echo "=== TESTCASE 13b: " | tee -a $logfile
...
chksum_ref="acc0375901a46233569de97c3928cd36a6276d5c836ee8553ca1f961a6275462"
chksum_prep

echo "=== TESTCASE 13c: " | tee -a $logfile
...
chksum_ref="5ab3ae0b16092a8b37f82518b4ac8cbfbafb04b3c94e0b1ecba4d0641d51f0e6"
chksum_prep
echo " " | tee -a $logfile
}
