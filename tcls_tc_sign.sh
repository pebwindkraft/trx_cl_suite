...
chksum_ref="e573caa89eaa59db11d28ad5b673a9560b07ecc6f5f26985036a6f56edede868"
chksum_prep
...
./tcls_sign.sh -v -f tmp_c_utx.txt -w KyP5KEp6DCmF222YM5EB9yGeMFxdVK1QWgtGvWnLRnDmiCtQPcN4 -p 03cc5debc62369bd861900b167bc6add5f1a6249bdab4146d5ce698879988dced0 > tmp_sign.log

head -n 38 tmp_sign.log > tmp_tx_cfile
echo " " >> tmp_tx_cfile
echo "###############################################" >> tmp_tx_cfile
...
echo " " >> tmp_tx_cfile
# we verify the signature with the script $tmp_vfy_fn, which is created by tcls_sign.sh 
# again, we take only the last line, to avoid ever changing signature data
echo "### $tmp_vfy_fn:" >> tmp_tx_cfile
./$tmp_vfy_fn | tail -n2 >> tmp_tx_cfile
echo " " >> tmp_tx_cfile
chksum_ref="462c41b1fe171d6e1792dc1ad2d63e36850fe11b7329d586c658ed653fdfc69a" 
chksum_prep
...
./tcls_sign.sh -v -f tmp_c_utx.txt -w KyP5KEp6DCmF222YM5EB9yGeMFxdVK1QWgtGvWnLRnDmiCtQPcN4 -p 03cc5debc62369bd861900b167bc6add5f1a6249bdab4146d5ce698879988dced0 > tmp_sign.log
head -n 69 tmp_sign.log > tmp_tx_cfile
echo " " >> tmp_tx_cfile
echo "###############################################" >> tmp_tx_cfile
echo "### signatures and hashes change every time ###" >> tmp_tx_cfile
echo "### for better verification, we search and  ###" >> tmp_tx_cfile
...
./$tmp_vfy_fn | tail -n2 >> tmp_tx_cfile
echo " " >> tmp_tx_cfile
chksum_ref="80031af63224fbb34d902a68e4560f0fa1c8637d42f5897630b37bcc1ccda7d2"
chksum_prep
...
./$tmp_vfy_fn | tail -n2 >> tmp_tx_cfile
echo " " >> tmp_tx_cfile
chksum_ref="ac7139d396ec854a6472fc9cb0cfa681fea9105f612e959e992cc67229303b87"
chksum_prep
...
./$tmp_vfy_fn | tail -n2 >> tmp_tx_cfile
echo " " >> tmp_tx_cfile
chksum_ref="ba4bd73c8a2f4f731ad9a22564c120b297933c9a063df354353e770c18ea5894" 
chksum_prep
...
echo " " >> tmp_tx_cfile
# we verify the three signatures with the script $tmp_vfy_fn, which is created by 
# tcls_sign.sha again, we grep specific lines, to avoid ever changing signature data
echo "### $tmp_vfy_fn:" >> tmp_tx_cfile
./$tmp_vfy_fn | grep -e "Signature Verified Successfully" -e "unsigned raw tx" >> tmp_tx_cfile
echo " " >> tmp_tx_cfile
chksum_ref="9cba70e659441d4d68b039357598f72ea295cc73c9d41b03ed5479d5a1a3a76c" 
chksum_prep
